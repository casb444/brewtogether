      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-10">
          <section>
            ...
            <h1 className="font-display text-4xl text-ink mb-3">Find your people, keep your focus</h1>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              {!visibleRooms.length && <p className="text-sm text-ink-muted">No public groups match that search. Start the first one.</p>}
            </div>
            {memberRooms.length > 0 && (
              <>
                <h2 className="font-display text-2xl text-ink mt-10 mb-4">Your groups</h2>
